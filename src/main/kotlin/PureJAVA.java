...
public class PureJAVA {
    ...
    private PureJAVA(byte[] key){
        initialize(wordsFromLEBytes(key), KEYED_HASH);
    }


    private PureJAVA(String context){
        PureJAVA contextHasher = new PureJAVA();
     ...
     */
    public static PureJAVA newInstance(){
        return new PureJAVA();
    }
     ...
     */
    public static PureJAVA newKeyDerivationHasher(String context){
        return new PureJAVA(context);
    }
}